...
const KakaoPayButton = dynamic(() => import('../account/kakao-pay-button'), { ssr: false });
const CopyAccountButton = dynamic(() => import('../account/copy-account-button'), { ssr: false });
        ...
        <Container maxWidth="lg" style={{ marginTop: '8vh' }} sx={{
          ...
          <Box sx={{
            ...
            <Typography fontWeight='bold' variant="body1">
              새마을금고 4107-1000-26579 (문근순)
              <CopyAccountButton account='4107-1000-26579' />
            </Typography>
