...
export class Flip {
  ...
  private flippingPage?: Page;
  private bottomPage?: Page;

  private calc?: FlipCalculation;
  ...
  public fold(globalPos: Point): void {
    ...
    if (!this.calc) this.start(globalPos);
  ...
  public flip(globalPos: Point): void {
    ...
    if (this.calc) this.render.finishAnimation();
    ...
    if (this.calc) {
      ...
      console.warn(`this.calc is undefined : ${this}`);
    }
  }
  ...
  private do(pagePos: Point): void {
    if (this.calc === undefined) return; // Flipping process not started
  ...
  private animateFlippingTo(
    ...
    this.render.startAnimation(frames, duration, () => {
      ...
      if (needReset) {
        this.render.setBottomPage();
        this.render.setFlippingPage();
  ...
  public getCalculation(): FlipCalculation | null {
    return this.calc ? this.calc : null;
  }
