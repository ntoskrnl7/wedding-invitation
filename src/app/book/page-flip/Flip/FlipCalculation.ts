...
export class FlipCalculation {
  ...
  private topIntersectPoint?: Point; // With top border
  private sideIntersectPoint?: Point; // With side border
  private bottomIntersectPoint?: Point; // With bottom border
  ...
  public getFlippingClipArea(): Point[] {
    ...
    if (this.topIntersectPoint) {
      result.push(this.topIntersectPoint);
    }

    if (this.sideIntersectPoint === undefined) {
      clipBottom = true;
    } else {
      result.push(this.sideIntersectPoint);

      if (this.bottomIntersectPoint === undefined) {
        clipBottom = false;
      }
    }

    if (this.bottomIntersectPoint) {
  ...
  public getBottomClipArea(): Point[] {
    ...
    if (this.corner === FlipCorner.TOP) {
      ...
      if (this.topIntersectPoint !== undefined) {
        result.push({ x: this.pageWidth, y: 0 });
      }
  ...
  public getAngle(): number {
    if (this.angle === undefined) {
      throw new Error(`angle is undefined ${this}`);
    }
  ...
  public getRect(): RectPoints {
    if (this.rect === undefined) {
      throw new Error(`rect is undefined ${this}`);
    }
  ...
  public getPosition(): Point {
    if (this.position === undefined) {
      throw new Error(`position is undefined ${this}`);
    }
  ...
  public getShadowStartPoint(): Point {
    if (this.corner === FlipCorner.TOP) {
      if (this.topIntersectPoint === undefined) {
        throw new Error(`topIntersectPoint is undefined ${this}`);
      }
      return this.topIntersectPoint;
    } else {
      if (this.sideIntersectPoint) return this.sideIntersectPoint;
      if (this.topIntersectPoint === undefined) {
        throw new Error(`topIntersectPoint is undefined ${this}`);
      }
      return this.topIntersectPoint;
  ...
  private getSegmentToShadowLine(): Segment {
    ...
    if (!second) {
      throw new Error(`second is undefined ${this}`);
    }
