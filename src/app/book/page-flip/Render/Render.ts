...
export abstract class Render {
  ...
  public finishAnimation(): void {
    if (this.animation !== undefined) {
      ...
      if (this.animation.onAnimateEnd !== undefined) {
        this.animation.onAnimateEnd();
      }
    }
  ...
  public getDirection(): FlipDirection {
    if (this.direction === undefined) {
      throw new Error(`this.direction is undefined ${this}`);
    }
  ...
  public getRect(): PageRect {
    if (this.boundsRect === undefined) this.calculateBoundsRect();
    if (this.boundsRect === undefined) {
      throw new Error(`this.boundsRect is undefined ${this}`);
    }
  ...
  public getOrientation(): Orientation {
    if (this.orientation === undefined) {
      throw new Error(`this.orientation is undefined ${this}`);
    }
  ...
  public setRightPage(page?: Page): void {
    if (page !== undefined) page.setOrientation(PageOrientation.RIGHT);
  ...
  public setLeftPage(page?: Page): void {
    if (page !== undefined) page.setOrientation(PageOrientation.LEFT);
  ...
  public convertToGlobal(pos: Point, direction?: FlipDirection): Point {
    ...
    if (pos === undefined) {
      throw new Error(`pos is undefined ${this}`);
    }
