...
export class PageFlip extends EventObject {
  ...
  private readonly setting: FlipSetting | null = null;
  ...
  public loadFromImages(imagesHref: string[]): void {
    if (!this.setting) {
      throw new Error(`settings is null ${this}`);
    }
  ...
  public updateFromImages(imagesHref: string[]): void {
    ...
    if (!this.render) {
      throw new Error(`render is undefined ${this}`);
    }
  ...
  public updateFromHtml(items: NodeListOf<HTMLElement> | HTMLElement[]): void {
    ...
    if (!this.ui) {
      throw new Error(`ui is null ${this}`);
    }
  ...
  public getPageCount(): number {
    if (!this.pages) {
      throw new Error(`pages is undefined ${this}`);
    }
  ...
  public getFlipController(): Flip | null {
    return this.flipController ? this.flipController : null;
  }
  ...
  public getSettings(): FlipSetting {
    if (!this.setting) {
      throw new Error(`setting is null ${this}`);
    }
    return this.setting;
  }
  ...
  public getUI(): UI {
    if (!this.ui) {
      throw new Error(`ui is undefined ${this}`);
    }
    return this.ui;
  }
  ...
  public getState(): FlippingState {
    if (!this.flipController) {
      throw new Error(`flipController is undefined ${this}`);
    }
